...
userPhone.onclick = function () {
  console.log("User **SELECTED** u field...");
...
submitionButton.addEventListener("mouseenter", function () { console.log(submitionButton) });
submitionButton.addEventListener("mouseleave", function () { console.log(submitionButton) });

submitionButton.addEventListener("mouseover", function () {
  submitionButton.style.fontSize = "25px";
  submitionButton.style.background = "green";
...
submitionButton.addEventListener("mouseleave", function () {
  ...
  submitionButton.style.background = "white";
...
form.addEventListener("submit", function (e) {
    ...
    if (
      ...
      userPhone.value === ""
        ...
        errorMessage.innerText = "Sorry, all fields must have value";
    }
